      ...
      <v-card-text>
        <v-container grid-list-md>
          <v-layout v-if="!loading" wrap>
            ...
            <v-flex xs12 md12>
              <v-select
                :items="facultyPersons"
                :error-messages="errors.dean"
                v-model="form.dean"
                item-text="name"
                item-value="id"
                return-object
            ...
            <v-flex xs12 md12>
              <v-select
                :items="facultyPersons"
                :error-messages="errors.secretaryHead"
                v-model="form.secretaryHead"
                item-text="name"
                item-value="id"
                return-object
                label="Secretarul-sef"
                chips
              ></v-select>
            </v-flex>
          </v-layout>
