  ...
  <v-card class="sign-up-wrapper pa-10">
    <div class="d-flex align-center justify-center flex-column">
      ...
      <div class="mt-10 mb-2">
        ...
        <p>
          The USV Stud Docs app stores and processes personal data that you have
          ...
          USV Stud Docs app won’t work properly or at all.
        </p>
        ...
        <p>
          ...
          Wi-Fi, or provided by your mobile network provider, but we cannot take
        ...
        <p>
          With respect to our responsibility for your use of the app, when
        ...
        <p>
          ...
          keep using the app. We do not promise that it will always update the
        ...
        <p>
          ...
          Conditions, do not hesitate to contact us at adryanbarbe@gmail.com.
        </p>
      </div>
    </div>
  </v-card>
